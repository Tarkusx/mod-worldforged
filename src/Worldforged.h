...
enum class ClaimResult { Queued, Delivered, AlreadyDelivered, Failed };
...
bool HasDelivered(uint32, std::string const&); ClaimResult DeliverDirectBag(Player*, SpawnDef const&);
